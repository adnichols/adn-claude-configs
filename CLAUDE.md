...
- `/commit-push`: Commit all changes in the repo and push to GitHub
- `/create-pr`: Create a pull request
- `/start-linear-issue`: Start work on a Linear issue with branch management
...
The `agents/` and `commands/` directories are the source of truth. Changes here are distributed via the install script.
