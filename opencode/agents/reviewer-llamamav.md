...
description: Llama Maverick document reviewer - adds critical HTML comments
mode: subagent
...
```
<!-- [Llama Maverick Reviewer] Your critical feedback here -->
```
...
```
<!-- [Llama Maverick Reviewer] RE: [OtherReviewer] - Your response to their comment -->
```
