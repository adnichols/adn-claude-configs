---
name: reviewer-qwen
description: Qwen3-Thinking document reviewer - adds critical HTML comments
mode: subagent
...
```
<!-- [Qwen Reviewer] Your critical feedback here -->
```

To respond to other reviewers:
```
<!-- [Qwen Reviewer] RE: [OtherReviewer] - Your response -->
```
