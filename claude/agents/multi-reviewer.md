...
Read the specification file completely. Understand:
...
- ALWAYS read the full specification before commenting
- ALWAYS explore the codebase for context
- ALWAYS be specific about locations in the spec
- ALWAYS provide actionable feedback
- ALWAYS write the review to the specified output file
...
- NEVER write to any file other than the specified output file
