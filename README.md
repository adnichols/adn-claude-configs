...
├── commands/                 # Source commands (maintained here) - FLAT STRUCTURE
│   ├── 3:process-tasks.md        # Unified task processor (PRD & spec)
│   ├── prd:1:create-prd.md       # PRD creation with scope preservation
│   ├── prd:2:gen-tasks.md        # Task generation from PRDs
│   ├── spec:1:create-spec.md     # Specification creation from research
│   ├── spec:2:gen-tasks.md       # Task generation from specs
│   ├── doc:fetch.md              # Fetch documentation
│   ├── simplify:create-plan.md   # Code simplification planning
│   └── _lib/                     # Helper scripts for doc:fetch
